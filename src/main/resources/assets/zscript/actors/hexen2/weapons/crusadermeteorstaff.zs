...
class CWeapMeteorStaff_Meteor : Rocket {
	...
	Default {
		...
		Speed 31.25;	//(1000 / 32) = ~1000 Quake Engine Velocity
		Radius 6;
		Height 6;
		Damage 65;
		DamageType "Fire";
        ...
        CWeapMeteorStaff_Meteor.tickDuration 142.8571428571429; // ~5 seconds
	}
	...
	void A_ExplodeRadius() {
		...
		double radius = Damage * (100.0f / 32.0f);	// Damage + 40
		A_Explode(Damage, radius, alert:true);
	}
}
// Trail