...
class SWeapFireStorm_FlameStream: Hexen2Projectile {
	...
	Default {
		...
		SWeapFireStorm_FlameStream.tickDuration (2.0 * TICRATEF);
	}
...
class SWeapFireStorm_Burner: Actor {
	...
	Default {
		...
		SWeapFireStorm_Burner.tickDuration (5.0 * TICRATEF);
	}
	...
	override void PostBeginPlay() {
		...
		self.tickDuration = (5 + random[swfs_burner](0, 5) * TICRATEF);
	}
	...
	void AttachToActor(Actor nextTarget) {
		...
		self.nextDamage = frandom(0.0, 0.5) * TICRATEF;
	}
...
class SWeapFireStorm_FlameBall: Hexen2Projectile {
	...
	Default {
		...
		//SWeapFireStorm_FlameBall.tickDuration (2.0 * TICRATEF);
	}
